...
<body style="background-color: beige;">
    <div class="position-absolute top-50 start-50 translate-middle text-center container-sm" style="outline: 1px solid black; border-radius: 20px; margin-top: 20px; max-width: 500px; background-color: white;">
        <div class="mb-5 mt-5">
            <div class="row">
                <p style="font-size: 34px;; font-weight: 900; color: #214E41">Регистрация</p>
            </div>
            <div class="row">
        ...
        <form action="BDreg.php" method="post">
            ...
            <button type="submit" class="btn btn-primary w-50 btn-lg btn-dark row mb-3" style="border-radius: 27px; font-weight: 900; background-color: #214E41; color: white;">Зарегистрироваться</button>
        </div>
        </form>
        <div class="row">
            <div class="col-6" style="text-align: end;">
                <p style="color: #214E41;">Есть аккаунт?</p>
            </div>
            <div class="col-6" style="text-align: start;">
                <a style="color: #214E41;" href="auth_page.php">Авторизация</a>
            </div>
        </div>
    </div>
</body>
